...
## About<!-- Required -->
This is the seond project on the second week of Patika+ bootcamp.
This project demonstrates the use of basic loops in C#. It includes several while loop examples that showcase different types of iterations and operations. 
<!-- 
