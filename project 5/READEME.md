...
## About<!-- Required -->
This is the fourth project on the second week of Patika+ bootcamp.
This project allows users to plan vacation trips by selecting destinations, calculating the cost based on travel options and the number of people, and offering detailed information about each location. The user can plan multiple vacations in a single session.
<!-- 
