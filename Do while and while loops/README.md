...
## About<!-- Required -->
This is the third project on the second week of Patika+ bootcamp.
This project demonstrates the difference between using While loop and Do-while loop in C#. It includes a Do while and While loop example that showcases difference between them. 
<!-- 
